...
def main(url):
    ...
    try:
        driver = webdriver.Chrome("Chrome Driver File Path Here, Example: C:\\Users\\User\\Chromedriver\\chromedriver.exe", options=options) #Put chromedriver.exe file loction between quotation marks using double back slashes.
